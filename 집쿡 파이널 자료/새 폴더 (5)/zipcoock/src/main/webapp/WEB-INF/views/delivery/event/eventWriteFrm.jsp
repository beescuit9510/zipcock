	...
	<div class="container" style="width: 1080px;">
		<form action="/eventWrite" method="post" enctype="multipart/form-data">
			<div class="eventWriteWrapper">
				...
				<div class="ew-content">
					<input type="file" id="uploadImg" name="mainEvent" onchange="loadImg(this);" accept=".jpg,.png,.jpeg,.gif">
				</div>
				<div class="ew-title">
					썸네일 미리보기
				</div>
				...
				<div class="ew-content">
					<input name="eventFinishDate" id="datepicker">
				</div>
				<div class="ew-title">
					내용
				</div>
				...
				<div>
					<button type="submit" class="buy_btn">등록하기</button>
				</div>
			</div>
		</form>
	</div>
